  ...
  function (_BaseController) {
    ...
    _createClass(controller, [{
      ...
      get: function get() {
        ...
        var action = function () {
          if (_this3.elements.form.hasAttribute('action')) {
            return _this3.elements.form.getAttribute('action');
          }
...
var registerElement = function registerElement(tag, options) {
  ...
  /*#__PURE__*/
  function (_options$extends$clas) {
    _inherits(_class, _options$extends$clas);
    ...
    function _class() {
      ...
      observedAttributes.forEach(function (attribute) {
        ...
        Object.defineProperty(_assertThisInitialized(_this), attribute, {
          configurable: false,
          enumerable: false,
          get: function get() {
    ...
    return _class;
  }(options.extends.class), options.extends.tag ? {
    extends: options.extends.tag
  } : undefined);
};
      ...
      handlers.push(function (mutation) {
        if (mutation.type === 'attributes' && nodeIsSupported(mutation.target)) {
          ...
          if (mutation.addedNodes) {
            var addedNodes = Array.from(mutation.addedNodes, function (node) {
          ...
          if (mutation.removedNodes) {
            var removedNodes = Array.from(mutation.removedNodes, function (node) {
              if (node.nodeType === Node.ELEMENT_NODE) {
                return node;
              }
...
function defineCustomElement(tag) {
  ...
  if (type === 'element' && !isValidTag) {
    throw new Error("".concat(tag, " is not a valid Custom Element name."));
  }
  ...
  var attributes = Array.isArray(options.attributes) ? options.attributes : []; // Validate extend
  ...
  var extend = function () {
    ...
    var parent = options.extends.class;
    return {
  ...
  var observedAttributes = addAttributesToController(options.controller, attributes);
