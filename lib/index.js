		...
		createClass(controller, [{
			...
			value: function prepare(method) {
				...
				var get$$1 = function get$$1() {
					var querystring = _this3.valuesAsQuerystring;
					var url = _this3.action + '?' + querystring;
					var params = {};
					params.method = _this3.method;
			...
			value: function validate() {
				...
				this.errorMessages = Array.from(this.elements.fields, function (field) {
			...
			key: 'valuesAsQuerystring',
			get: function get$$1() {
				return Array.from(this.values, function (_ref) {
					var _ref2 = slicedToArray(_ref, 2),
					    key = _ref2[0],
					    raw = _ref2[1];
